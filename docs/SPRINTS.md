...
- [ ] **AI Tutor Bot:**
  - Embed a chat interface in every lesson.
  - Context-aware answers based *only* on the current lesson content (RAG architecture).
- [ ] **Automated Quizzes:**
...
*Document generated by Jules, AI Engineer.*
